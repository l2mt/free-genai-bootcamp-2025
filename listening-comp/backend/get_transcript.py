...
class YouTubeTranscriptDownloader:
    ...
    def save_transcript(self, transcript: List[Dict], filename: str) -> bool:
        ...
        """
        directory = os.path.join(os.getcwd(),'data', 'transcripts')
...
if __name__ == "__main__":
    video_id = "https://www.youtube.com/watch?v=R-kepxbu5fM"  # Extract from URL: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
